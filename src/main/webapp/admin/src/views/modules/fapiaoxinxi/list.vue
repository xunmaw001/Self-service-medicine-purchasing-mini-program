  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="发票类型" prop="fapiaoleixing">
		  <el-select  @change="fapiaoleixingChange" clearable v-model="searchForm.fapiaoleixing" placeholder="请选择发票类型">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="发票类型">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="fapiaotupian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="发票图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.fapiaotupian">
                        <img :src="$base.url+scope.row.fapiaotupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.fapiaoleixing!='' && this.searchForm.fapiaoleixing!=undefined){
