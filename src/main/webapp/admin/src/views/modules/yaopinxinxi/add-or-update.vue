<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="药品成分" prop="yaopinchengfen">
          <el-input v-model="ruleForm.yaopinchengfen" 
              placeholder="药品成分" clearable  :readonly="ro.yaopinchengfen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="药品成分" prop="yaopinchengfen">
              <el-input v-model="ruleForm.yaopinchengfen" 
                placeholder="药品成分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yaopinfenlei = true;
          ...
          if(o=='yaopinchengfen'){
            this.ruleForm.yaopinchengfen = obj[o];
	    this.ro.yaopinchengfen = true;
            continue;
          }
          if(o=='shengchanshang'){
