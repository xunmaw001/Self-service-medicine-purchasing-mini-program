  ...
  <div class="main-content">
    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
		...
		<el-form-item class="select" label="药品分类" prop="yaopinfenlei">
		  <el-select  @change="yaopinfenleiChange" clearable v-model="searchForm.yaopinfenlei" placeholder="请选择药品分类">
		    <el-option
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign" 
               :header-align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('yaopinxinxi','开票') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="fapiaoxinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'开票':'' }}</el-button>
                <el-button v-if="isAuth('yaopinxinxi','开票') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="fapiaoxinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'开票':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('yaopinxinxi','开票') && contents.tableBtnIcon == 0" type="success" size="mini" @click="fapiaoxinxiCrossAddOrUpdateHandler(scope.row,'cross','','','')">{{ contents.tableBtnFont == 1?'开票':'' }}</el-button>
    ...
    <fapiaoxinxi-cross-add-or-update v-if="fapiaoxinxiCrossAddOrUpdateFlag" :parent="this" ref="fapiaoxinxiCrossaddOrUpdate"></fapiaoxinxi-cross-add-or-update>
...
import fapiaoxinxiCrossAddOrUpdate from "../fapiaoxinxi/add-or-update";
export default {
  data() {
    return {
      yaopinfenleiOptions: [],
      ...
      fapiaoxinxiCrossAddOrUpdateFlag: false,
  ...
  methods: {
    ...
    fapiaoxinxiCrossAddOrUpdateHandler(row,type,crossOptAudit,statusColumnName,tips,statusColumnValue){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.fapiaoxinxiCrossAddOrUpdateFlag = true;
		...
		for (var o in obj){
		  if(o==statusColumnName && obj[o]==statusColumnValue){
			...
			this.getDataList();
		      ...
		      this.showFlag = true;
		      this.fapiaoxinxiCrossAddOrUpdateFlag = false;
			return;
		  }
		}
	}
      this.$nextTick(() => {
      this.$refs.fapiaoxinxiCrossaddOrUpdate.init(row.id,type);
      });
    },
    init () {
          this.$http({
